...
### Database Coverage
- **929 D3D12 APIs** - Device interfaces, command lists, resources, pipeline states
- **14 DXR Raytracing Entities** - Acceleration structures, state objects, ray dispatch
- **33 HLSL Raytracing Intrinsics** - Complete function library with shader stage compatibility
