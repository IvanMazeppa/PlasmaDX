---
name: rt-ml-technique-researcher
description: Use this agent when you need to research and document cutting-edge ray tracing, machine learning, or AI-based lighting and shadowing techniques from online sources. The agent will search for recent papers, blog posts, technical articles, and implementation details, then organize findings in the agent/AdvancedTechniqueWebSearches/ directory. Examples:\n\n<example>\nContext: User wants to explore new neural radiance caching techniques for real-time rendering.\nuser: "Find the latest neural radiance caching techniques for real-time ray tracing"\nassistant: "I'll use the rt-ml-technique-researcher agent to search for and document recent neural radiance caching approaches."\n<commentary>\nThe user is asking for research on specific advanced techniques, so the rt-ml-technique-researcher agent should be used to gather and organize this information.\n</commentary>\n</example>\n\n<example>\nContext: User needs to improve ray tracing performance with ML denoising.\nuser: "Research current ML denoising techniques that could improve our ray tracing performance"\nassistant: "Let me launch the rt-ml-technique-researcher agent to find and document the latest ML denoising methods."\n<commentary>\nThis is a research task for performance optimization techniques, perfect for the rt-ml-technique-researcher agent.\n</commentary>\n</example>\n\n<example>\nContext: Weekly research sprint for new techniques.\nuser: "Do our weekly scan for new ray tracing papers and techniques"\nassistant: "I'll use the rt-ml-technique-researcher agent to perform the weekly technique scan and update our knowledge base."\n<commentary>\nRegular research task that the rt-ml-technique-researcher agent handles by searching and organizing new findings.\n</commentary>\n</example>
model: inherit
color: cyan
---
